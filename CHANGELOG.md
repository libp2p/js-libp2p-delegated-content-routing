<a name="0.2.4"></a>
## [0.2.4](https://github.com/libp2p/js-libp2p-delegated-content-routing/compare/v0.2.3...v0.2.4) (2019-07-29)


### Bug Fixes

* limit concurrent HTTP requests  (backport for 0.2.x) ([#17](https://github.com/libp2p/js-libp2p-delegated-content-routing/issues/17)) ([2ea1334](https://github.com/libp2p/js-libp2p-delegated-content-routing/commit/2ea1334))
